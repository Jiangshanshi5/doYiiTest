...
$str=<<<aa
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{$row['tid']}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{$row['user']}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{$row['info']}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{$row['addtime']}</td>
        <td align="center" valign="middle" class="borderbottom">
       <a href="del.php?id={$row['id']}&name={$row['picname']}" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
aa;
         echo $str; 
}       
