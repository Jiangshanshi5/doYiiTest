  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search" background="../images/new_002.jpg">
  		<tr>
  		  ...
  		  <td width="10%" align="center" valign="middle" style="text-align:right; width:150px;" background="../images/new_002.jpg"><a href="./index.php" target="show" onFocus="this.blur()" class="add"></a></td>
  		</tr>
	</table>
    </td>
  </tr>
...
$str=<<<aa
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{$row['addtime']}
        <td align="center" valign="middle" class="borderright borderbottom">{$row['total']}
        <td align="center" valign="middle" class="borderright borderbottom">{$aa[$row['status']]}
        <td align="center" valign="middle" class="borderbottom">
       <a href="del.php?id={$row['id']}&name={$row['picname']}" onFocus="this.blur()" class="add">已收货</a><span class="gray">&nbsp;|&nbsp;</span><a href="change.php?id={$row['id']}&name={$row['picname']}" onFocus="this.blur()" class="add">修改信息</a><span class="gray">&nbsp;|&nbsp;</span><a href="action.php?id={$row['id']}&a=putout" onFocus="this.blur()" class="add">发货</a></td>
      </tr>
aa;
         echo $str; 
}       
