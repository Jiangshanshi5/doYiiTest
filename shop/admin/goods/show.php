    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search" background="../images/new_002.jpg">
  		<tr>
   		 <td width="90%" align="left" valign="middle">
	         ...
	         <span>类别名：</span>
	         <input type="text" name="goods" value="<?php echo $_POST['goods']; ?>" class="text-word">
            </select>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">图片名</th>
...
//=====================================================================//
        ...
        $page=isset($_GET['page']) ?$_GET['page'] :1;//接受查看的页码
				...
				$sql = "select * from goods ".$where.$limit;
        $res=mysql_query($sql);
        //5
        $aa=array(0=>'售空',1=>'在售');
...
$str=<<<aa
    <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{$row['goods']}</td>
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{$aa[$row['state']]}
        </td><td align="center" valign="middle" class="borderright borderbottom">{$row['store']}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{$row['num']}</td>
        <td align="center" valign="middle" class="borderright borderbottom">{$row['clicknum']}</td>
