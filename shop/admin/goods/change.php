...
<?php
        ...
        switch($_GET['errno']){
            case 2:
                echo $_GET['error'];break;
        }
        echo "<center>";
         echo "<b style=\"font-size:25px\";>修改商品信息</b>";
        echo "</center>";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form method="post" action="action.php?a=change&id=<?php echo $_GET['id']; ?>&name=<?php echo $row['picname']; ?>" enctype="multipart/form-data">
...
<?php 
        ...
        $sql11="select * from type order by concat(path,id)";
        $res11=mysql_query($sql11);
        
         echo "<select name=\"typeid\" id=\"level\">";
         while($row11=mysql_fetch_assoc($res11)){
             $disable="";
            $n=substr_count($row11['path'],",");
            $path=str_repeat("&nbsp;&nbsp;","$n");
            echo "<option  value={$row11['id']}>{$path}{$row11['name']}</option>";
             }
        echo "</select>";
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="descr" value="<?php echo $row['descr']; ?>" class="text-word">
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">重新上传图片：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="file" name="picname" value="<?php echo $row['picname']; ?>" class="text-word">
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">状态：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="radio" name="state" <?php  echo $row['state']=="0" ? "checked":""; ?> value="0" > 售空
        <input type="radio" name="state" <?php  echo $row['state']=="1" ? "checked":""; ?> value="1"> 在售
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="num" value="<?php echo $row['num']; ?>" class="text-word">
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
