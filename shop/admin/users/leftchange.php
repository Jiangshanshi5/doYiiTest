...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：用户管理&nbsp;&nbsp;>&nbsp;&nbsp;添加信息</td>
  </tr>
<tr>&nbsp;</tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="leftaction.php?a=edit&id=<?php echo $row['id']; ?>&addtime=<?php echo $row['addtime']; ?>">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="pass" value="<?php echo $row['pass']; ?>" class="text-word">
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">性别：</td>
        <td align="left" valign="middle" >
        <input type="radio" name="sex" <?php echo $row['sex']=="1" ? "checked":"";?> value="1" class="text-word">男
        <input type="radio" name="sex" <?php echo $row['sex']=="0" ? "checked":"";?> value="0" class="text-word">女
        </td>
        </tr>
        <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">家庭住址：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="email" name="email" value="<?php echo $row['email']; ?>" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	    ...
	    <option value="2" <?php echo $row['state']=="2" ? "selected" :"";?>  >&nbsp;&nbsp;会员</option>
	    <option value="1" <?php echo $row['state']=="1" ? "selected":"";?> >&nbsp;&nbsp;一般管理员</option>
	    <option value="0" <?php echo $row['state']=="0" ? "selected":"";?> >&nbsp;&nbsp;创建者</option>
        </select>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
